...
export function MedicalProfile() {
  ...
  const [medicalData, setMedicalData] = useState<MedicalData>({
    ...
    emergencyContacts: [
      { name: "John Smith", phone: "+1-555-0123", relation: "Spouse" },
      { name: "Dr. Sarah Johnson", phone: "+1-555-0456", relation: "Primary Care" }
    ],
    notes: "Wears contact lenses. Prefers left arm for IV access."
  });
