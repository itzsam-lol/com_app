          ...
          <div className="grid md:grid-cols-3 gap-6 animate-slide-up">
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white">
              <CardContent className="p-6 text-center space-y-3">
                ...
                <p className="text-white/80 text-sm">24/7 emergency monitoring and instant response</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white">
              <CardContent className="p-6 text-center space-y-3">
                ...
                <p className="text-white/80 text-sm">AI-powered health coaching and medication management</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white">
              <CardContent className="p-6 text-center space-y-3">
                ...
                <p className="text-white/80 text-sm">98.5% success rate with 2.3min average response time</p>
              </CardContent>
            </Card>
          </div>
            ...
            <div className="bg-emergency/10 backdrop-blur-sm rounded-2xl p-6 border border-emergency/20">
              <div className="flex flex-col sm:flex-row items-center gap-4">
                ...
                <div className="text-center sm:text-left flex-1">
                  <h3 className="font-semibold text-white mb-1">Emergency Situation?</h3>
                  <p className="text-white/80 text-sm">Call our emergency hotline for immediate assistance</p>
                </div>
                <Button 
                  variant="outline" 
